		...
		<div class="container">
			<div class="check_box">
				<div class="col-md-9 cart-items">
						...
						<div class="cart-header" style="float: left;">
							...
							<div class="cart-sec simpleCart_shelfItem">
								...
								<div class="cart-item-info" style="float: left;">
									<h3>
										<a href="#">${varitems.goods.gName }</a>
									</h3>
									<ul class="qty">
										<li><p>规格：${varitems.goods.gStandard }</p></li>
										<li><p>优惠：${varitems.goods.gDiscount }</p></li>
										<li><p>数量：${varitems.goodsQuantity}</p></li>
										<!-- <li style="text-align: right;"><p>删除</p></li>
										<li style="text-align: right;"><p>修改</p></li> -->
									</ul>
									<h5>${varitems.goods.gDetail }</h5><br>
									<p>单价 : ￥${varitems.goods.gPrice }</p>
								</div>
								<div class="clearfix"></div>
							</div>
						</div>
					...
					<form action="./WarehouseService" name="order_form" method="post">
						<input type="hidden" name="action" value="payForBill">
						<span>请输入收货地址</span><p><input type="text" name="userAddress" ></p>
