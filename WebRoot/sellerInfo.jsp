	...
	<div class="container">
		...
		<div class=" register-top">
			...
			<input type="hidden" name="ID" value="${seller.sId }">
				<div> 	
				<span>商家名称</span>
				<input type="text"  name="sellerName" value="${seller.sName }"> 
			</div>
			<div> 
				<span >商家地址</span>
				<input type="text" name="address" value="${seller.sAddress }">
			</div>
			<div> 
				<span >商家电话</span>
				<input type="text" name="telephone" value="${seller.sPhone }">
			</div>
			<div> 
				<span >商家密码</span>
				<input type="password" name="sellerPwd" value="${seller.sPwd }">
			</div>
				...
				<br/><br/><br/>
					<div class="single-bottom">
						...
						<li>
							<br/>
							<label for="brand"><span></span> 查看订单</label>
						</li>
						<li>
							<br/>
							<label for="brand1"><span></span>修改订单</label>
						</li>
						<li>
							<br/>
							<label for="brand2"><span></span> 取消订单</label>
						</li>
					...
					<div class="single-bottom">
						...
						<li>
							<br/>
							<label for="color1"><span></span> 添加商品</label>
						</li>
